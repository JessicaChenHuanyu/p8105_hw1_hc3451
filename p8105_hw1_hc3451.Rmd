...
The variables in this dataset includes: year, month, day, etc. with the value of int; temp, dewp, humid, etc. with the value of dbl. This dataset has 235 rows and 15 columns. The mean temperature is 39.58.
